...
<head>
  <meta charset="UTF-8">
  <title>Bulk SMS Services</title><link rel="stylesheet" href="../style.css">
  <style>
    .container {
        padding: 0 7rem;
        display: flex;
...
<section class="services">
  ...
  <img class="servicesimg" src="../assets/sms_trans.png" alt="Services">
...
<div class="container fade-in">
      <!-- Left Video Section -->
      <video src="../assets/smsvid.mp4" height="580" autoplay muted loop playsinline></video>
